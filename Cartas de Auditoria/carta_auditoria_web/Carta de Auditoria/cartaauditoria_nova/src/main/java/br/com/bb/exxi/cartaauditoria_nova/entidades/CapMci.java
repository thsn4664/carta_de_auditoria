...
public class CapMci implements Serializable {
    ...
    @Column(name = "ok_baixa_cdc")/*verificar atualização e utilização*/
    private String okBaixaCdc;
    
    @Column(name = "ok_autorizacao_scr") /*verificar atualização e utilização*/
    private String okScr;
    
    @Column(name = "anot_imped") /*verificar atualização e utilização*/
    private String okAnotImped;
    
    @Column(name = "cnpj")
    private String cnpj;
    
    @Column(name = "dt_ref") /*verificar atualização e utilização*/
    ...
    @Column(name = "vl_faturamento") /*verificar atualização e utilização*/
    private Double vlFat;

    @Column(name = "ano_mes_faturamento") /*verificar atualização e utilização*/
    private String mesFat;
    
    @Column(name = "cod_carteira") /*verificar atualização e utilização*/
    private Integer cdCarteira;
    
    @Column(name = "nm_carteira") /*verificar atualização e utilização*/
    ...
    @Column(name = "cod_restrito") /*verificar atualização e utilização*/
    private Integer cdRestrito;
    
    @Column(name = "tp_pessoa") /*verificar atualização e utilização*/
