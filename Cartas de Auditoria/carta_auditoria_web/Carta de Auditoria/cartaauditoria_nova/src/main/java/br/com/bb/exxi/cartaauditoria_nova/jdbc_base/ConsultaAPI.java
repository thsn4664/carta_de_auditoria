...
public class ConsultaAPI {
    ...
    public String postAPI(String endereco,String BBSSOToken, String parametros) {
        ...
        try {
            ...
            conn = (HttpsURLConnection) new URL(endereco).openConnection();
            conn.setRequestMethod("POST");
            conn.setConnectTimeout(800);
            conn.setRequestProperty("accept", "application/json");
            conn.setRequestProperty("Content-Type", "application/json");            
            conn.setRequestProperty("Cookie", "BBSSOToken="+BBSSOToken+"");
            conn.setDoOutput(true);
            PrintStream printStream = new PrintStream(conn.getOutputStream());

            conn.connect();
            
            //System.out.println("postAPI parametros"+parametros);
            printStream.println(parametros); 
